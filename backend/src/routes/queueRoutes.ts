...
queueRoutes.post("/queue/:queueId/media-upload", isAuth, upload.array("file"), QueueController.mediaUpload);
queueRoutes.delete("/queue/:queueId/media-upload", isAuth, QueueController.deleteMedia);
