...
const WhatsAppModal = ({open, onClose, whatsAppId}) => {
    ...
    useEffect(() => {
        const fetchSession = async () => {
            ...
            try {
                ...
                data.integrationId ? setSelectedIntegration(data.integrationId) : setSelectedIntegration(null);
    ...
    // Atualize as funções handleChangePrompt e handleChangeIntegrationId para armazenar os valores selecionados
    ...
    const handleSaveWhatsApp = async (values) => {
        ...
        const whatsappData = {
            ...
            token: autoToken,
            schedules,
            promptId: selectedPrompt !== null && selectedPrompt !== "" ? selectedPrompt : 0,
            integrationId: selectedIntegration !== null && selectedIntegration !== "" ? selectedIntegration : 0
        };
        ...
        try {
            if (whatsAppId) {
                ...
                if (!attachmentName && (whatsApp.greetingMediaAttachment)) {
                        ...
                        <Form>
                            <Paper className={classes.mainPaper} elevation={1}>
                                ...
                                >
                                    ...
                                    {schedulesEnabled &&
                                        <Tab label={i18n.t("whatsappModal.tabs.schedules")} value={"schedules"}/>}
                                </Tabs>
                            </Paper>
                                        ...
                                        <Grid spacing={2} container>
                                            ...
                                            <Grid xs={6} md={6} item>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <MenuItem
                                                            value={"0"}>{i18n.t("whatsappModal.form.closeLastMessageOptions1")}</MenuItem>
                                                        <MenuItem
                                                            value={"1"}>{i18n.t("whatsappModal.form.closeLastMessageOptions2")}</MenuItem>
                                                    </Field>
                                                </FormControl>
                                            </Grid>
                                        </Grid>
