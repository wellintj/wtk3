...
import CloseIcon from "@material-ui/icons/KeyboardTab";
			...
			>
				...
				{loading ? (
					...
					<div className={classes.content}>
						...
						<Avatar src={contact.profilePicUrl} alt="contact_image" style={{ width: 60, height: 60, backgroundColor: generateColor(contact?.number), color: "white", fontWeight: "bold" }}>{ getInitials(contact?.name) }</Avatar>
							<CardHeader
								onClick={() => {}}
